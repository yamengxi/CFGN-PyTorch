...
# --save CFGN-base+CFGM_BIX2_F64R8 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# # train Base+ACT+CFGM (CFGG)
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5 python -u main.py --n_GPUs 6 \
# --model CFGN --scale 2 --n_feats 64 --n_resgroups 8 --act lrelu --block_type CFGM \
# --save CFGN-base+ACT+CFGM_BIX2_F64R8 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
...
--save CFGN_SRB_BIX2_F52R6 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
...
--save CFGN_CFGM_v1_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# train CFGM_v2
CUDA_VISIBLE_DEVICES=0,1,2 python -u main.py --n_GPUs 3 \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act identity --block_type CFGM_v2 \
--save CFGN_CFGM_v2_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# train ButterflyConv_v1
CUDA_VISIBLE_DEVICES=0,1,2 python -u main.py --n_GPUs 3 \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act identity --block_type ButterflyConv_v1 \
--save CFGN_ButterflyConv_v1_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# train ButterflyConv_v2
CUDA_VISIBLE_DEVICES=0,1,2 python -u main.py --n_GPUs 3 \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act identity --block_type ButterflyConv_v2 \
--save CFGN_ButterflyConv_v2_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
...
--save CFGN_SRB+ACT_BIX2_F52R6 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# train CFGM_v1 + ACT
CUDA_VISIBLE_DEVICES=0,1,2 python -u main.py --n_GPUs 3 \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act lrelu --block_type CFGM_v1 \
--save CFGN_CFGM_v1+ACT_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# train CFGM_v2 + ACT
CUDA_VISIBLE_DEVICES=0,1,2 python -u main.py --n_GPUs 3 \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act lrelu --block_type CFGM_v2 \
--save CFGN_CFGM_v2+ACT_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
...
--save CFGN_ButterflyConv_v1+ACT_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
...
--save CFGN_ButterflyConv_v2+ACT_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
...
# --model CFGN --scale 2 --n_feats 52 --n_resgroups 6 --act lrelu --block_type base \
# --save CFGN-base+ACT_BIX2_F52R6 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# # train Base+CFGM
# CUDA_VISIBLE_DEVICES=0,1,2 python -u main.py --n_GPUs 3 \
# --model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act identity --block_type CFGM \
# --save CFGN-base+CFGM_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 64 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0

# # train Base+ACT+CFGM (CFGN)
# CUDA_VISIBLE_DEVICES=0,1,2 python -u main.py --n_GPUs 3 \
# --model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act lrelu --block_type CFGM \
# --save CFGN-base+ACT+CFGM_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100 --batch_size 3 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
...
--save CFGN-base+ACT+CFGM_BIX2_F64R11 --data_test Set5+Set14+B100+Urban100 --batch_size 3 --patch_size 128 --save_results --lr 0.0005 --decay 200-400-600-800-1000-1100-1200-1300-1400-1500 --epochs 0 # --test_every 0
