...
# CFGN scale = 3
CUDA_VISIBLE_DEVICES=0,1,2,3 python -u main.py --n_GPUs 4 --n_threads 8 \
--model CFGN --scale 3 --n_feats 64 --n_resgroups 9 --act lrelu --block_type CFGM_v2 --dilation 3 --pre_train /home/Leeyegy/yamengxi/EDSR-PyTorch/experiment/model_latest.pt \
...
CUDA_VISIBLE_DEVICES=4,5,6,7 python -u main.py --n_GPUs 4 --n_threads 8 --pre_train /data/yamengxi/EDSR-PyTorch/experiment/model_246.pt \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act lrelu --block_type CFGM_v2 --dilation 3 \
--save CFGN_CFGM_v2+ACT_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100+Manga109 --batch_size 64 --patch_size 128 --save_models --lr 0.00025 --decay 200-400-600-800-1000-1200 --epochs 0 # --test_every 0


CUDA_VISIBLE_DEVICES=0,1 python -u main.py --n_GPUs 2 --n_threads 4 --pre_train /data/yamengxi/EDSR-PyTorch/experiment/model_246.pt \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act lrelu --block_type CFGM_v2 --dilation 3 \
--save CFGN_CFGM_v2+ACT_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100+Manga109 --batch_size 64 --patch_size 128 --save_models --lr 0.00025 --decay 200-400-600-800-1000-1200 --epochs 0 --test_only # --test_every 0



CUDA_VISIBLE_DEVICES=2,3 python -u main.py --n_GPUs 2 --n_threads 4 \
--model CFGN --scale 2 --n_feats 64 --n_resgroups 9 --act lrelu --block_type CFGM_v2 --dilation 3 \
--save CFGN_CFGM_v2+ACT_BIX2_F64R9 --data_test Set5+Set14+B100+Urban100+Manga109 --batch_size 64 --patch_size 128 --save_models --lr 0.0005 --decay 200-400-600-800-1000-1200 --epochs 0 # --test_every 0
